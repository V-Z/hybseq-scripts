...
# DATADIR="/storage/pruhonice1-ibot/home/gunnera/minuartia_ddrad/1_demultiplexed"
# DATADIR="/storage/pruhonice1-ibot/shared/anastatica/HiC_anast_coch/0_data"
DATADIR="/storage/pruhonice1-ibot/shared/anastatica/seq_data/0_data/lib01/0_data/$D/0_data"
...
# ./hybseq_1_prep_2_run.sh -f 0_data -c 6 -o 1_trimmed -d 2_dedup -q 3_qual_rep -a adaptors.fa -m 64 -t /cvmfs/software.metacentrum.cz/spack18/software/linux-debian11-x86_64_v2/gcc-10.2.1/trimmomatic-0.39-uuuagj7ae3wim6rdyxkncii4jiuikejy/bin/trimmomatic-0.39.jar | tee hybseq_prepare.log
...
# ./hybseq_1_prep_2_run.sh -f 1_demultiplexed -c 4 -o 2_trimmed -d 3_dedup -q 4_qual_rep -a adaptors.fa -m 16 -t /cvmfs/software.metacentrum.cz/spack18/software/linux-debian11-x86_64_v2/gcc-10.2.1/trimmomatic-0.39-uuuagj7ae3wim6rdyxkncii4jiuikejy/bin/trimmomatic-0.39.jar | tee hybseq_prepare.log
